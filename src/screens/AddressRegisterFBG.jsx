...
export const AddressRegisterFBG = ({ navigation, route }) => {
    const { nombre, numero_tel } = route.params;
    ...
    const handleRegister = async () => {
        try {
            if (estado.trim() !== '' && ciudad.trim() !== '' && colonia.trim() !== '' && calle.trim() !== '' && numero.trim() !== '' && cp.trim() !== '') {
                ...
                await setDoc(doc(db, 'Usuario', user_id), { nombre: nombre, idEnvio: envio.id, tipo: 'cliente', telefono: numero_tel });
